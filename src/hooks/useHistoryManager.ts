...
export const useHistoryManager = ({
  ...
  const handleSelectHistory = useCallback((item: HistoryItem) => {
    ...
    resetSession(newId);
    setConsoleLogs([]); // Ensure logs are cleared on history view
    ...
    feedback('success');
  }, [resetSession, setSongs, setAiDjResponse, setVideoLinks, setCurrentMood, setCurrentVibeId, setRequestedCount, resultsRef, feedback, setConsoleLogs]);
