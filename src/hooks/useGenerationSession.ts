...
export const useGenerationSession = ({
  ...
  }, [clearStatusLogs, setSongs, setVideoLinks, setConsoleLogs, setIsMajorBlocked, setIsContaminated, setIsError, setExportSuccess, setIsHistoryView, setExporting, setAiDjResponse, resolvedTitlesRegistry, inFlightResolutions]);
  ...
  }, [googleAiKey, resetSession, feedback, addLog, globalSeenTitles, startProgressiveLogs, clearStatusLogs, setAiDjResponse, setRequestedCount, setCurrentMood, setIsMajorBlocked, setIsContaminated, setIsError, resultsRef]);
  ...
  }, [addLog, resetSession, feedback, globalSeenTitles, startProgressiveLogs, clearStatusLogs, setVideoLinks, setCurrentMood, setRequestedCount, setIsMajorBlocked, setIsContaminated, setIsError]);
